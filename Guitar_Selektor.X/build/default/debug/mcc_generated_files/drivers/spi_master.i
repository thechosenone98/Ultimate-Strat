...
# 1 "mcc_generated_files/drivers/../spi.h" 1
# 54 "mcc_generated_files/drivers/../spi.h"
...
# 54 "mcc_generated_files/drivers/../spi.h" 2
...
_Bool EINK_open(void);

const spi_master_functions_t spiMaster[] = {
    { SPI_Close, EINK_open, SPI_ExchangeByte, SPI_ExchangeBlock, SPI_WriteBlock, SPI_ReadBlock, SPI_WriteByte, SPI_ReadByte, ((void*)0), ((void*)0) }
};

_Bool EINK_open(void){
    return SPI_Open(EINK_CONFIG);
}
